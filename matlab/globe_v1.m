...
npanels = 36;%180;   % Number of globe panels around the equator deg/panel = 360/npanels
...
%image_file = '2232_ban.jpg';
%image_file = 'srtmCoverage.png';
image_file = strcat(startpath,'\Images\earthmap10k.reduced.jpg');
