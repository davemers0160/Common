function pso_member = validate_mnist_pso_member(pso_member, pso_member_limits)
    ...
    pso_member.fc = max(floor(pso_member.fc(:,1)+0.5), pso_member_limits.fc(:,1));
    pso_member.fc = min(pso_member.fc(:,1), pso_member_limits.fc(:,2));    
