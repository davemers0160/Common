function pso_velocity = validate_mnist_pso_velocity(pso_velocity, pso_velocity_limits)
    ...
    pso_velocity.fc = max(pso_velocity.fc(:,1), pso_velocity_limits.fc(:,1));
    pso_velocity.fc = min(pso_velocity.fc(:,1), pso_velocity_limits.fc(:,2));   
