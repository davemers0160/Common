function [iq] = generate_4fsk(data, amplitude, sample_rate, symbol_length, offset_frequency, freq_deviation)
    ...
    m = [ -3.0/3.0, -1.0/3.0, 1.0/3.0, 3.0/3.0 ];
