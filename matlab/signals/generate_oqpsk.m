function [iq] = generate_oqpsk(data, sample_rate, half_bit_length)

    samples_per_bit = floor(sample_rate * half_bit_length);
    ...
    I = cat(1, I, zeros(samples_per_bit,1));
