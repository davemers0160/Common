...
template <int N1, int N2, int N3, typename SUBNET> using blk = dlib::bn_con<con1<N1, dlib::relu<dlib::bn_con<con13<N2, con31<N2, dlib::relu<dlib::bn_con<con1<N3, SUBNET>>>>>>>>>;
template <int N1, int N2, int N3, typename SUBNET> using ablk = dlib::affine<con1<N1, dlib::relu<dlib::affine<con13<N2, con31<N2, dlib::relu<dlib::affine<con1<N3, SUBNET>>>>>>>>>;
...
using res_blk = dlib::relu<dlib::add_prev1<blk<N1,N2,N3, dlib::tag1<SUBNET>>>>;
template <int N1,int N2,int N3, typename SUBNET>
using ares_blk = dlib::relu<dlib::add_prev1<ablk<N1,N2,N3, dlib::tag1<SUBNET>>>>;
...
using resnet_type = dlib::loss_multiclass_log< dlib::fc<1000, dlib::avg_pool_everything<
    ...
    con2d<256, dlib::relu<dlib::bn_con<mp7<
...
using aresnet_type = dlib::loss_multiclass_log< dlib::fc<1000, dlib::avg_pool_everything<
    ...
    con2d<256, dlib::relu<dlib::affine<mp7<
    dlib::input_rgb_image_sized<230>
    >>>> >> >> >> > >>>;
...
using ml_net_type = dlib::loss_mmod<con9<1,
    ...
    con2d<1024, scale_blk2<512,128,128,
    con2d<512, scale_blk1<256,64,64,
    con2d<256, dlib::prelu<dlib::bn_con<mp7<    
    //----
...
using aml_net_type = dlib::loss_mmod<con9<1,
    ...
    con2d<1024, ascale_blk2<512,128,128,
    con2d<512, ascale_blk1<256,64,64,
    con2d<256, dlib::prelu<dlib::affine<mp7<    
    //----
    dlib::input_array_image_pyramid<dlib::pyramid_down<6>, array_depth>
    >>>> >> >> >> > >>> >>;    
