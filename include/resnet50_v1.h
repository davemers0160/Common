...
template <int N1, int N2, int N3, typename SUBNET> using blk = dlib::bn_con<con1<N1, dlib::relu<dlib::bn_con<con3<N2, dlib::relu<dlib::bn_con<con1<N3, SUBNET>>>>>>>>;
template <int N1, int N2, int N3, typename SUBNET> using ablk = dlib::affine<con1<N1, dlib::relu<dlib::affine<con3<N2, dlib::relu<dlib::affine<con1<N3, SUBNET>>>>>>>>;
template <int N, typename SUBNET> using cbp3_blk = dlib::relu<dlib::bn_con<con3<N, SUBNET>>>;
...
using resnet_type = dlib::loss_multiclass_log< dlib::fc<1000, dlib::avg_pool_everything<
    ...
    con2d<256, dlib::relu<dlib::bn_con<con7d<64,
...
using aresnet_type = dlib::loss_multiclass_log< dlib::fc<1000, dlib::avg_pool_everything<
    ...
    con2d<256, dlib::relu<dlib::affine<con7d<64,
    dlib::input_rgb_image_sized<230>
    >>>> >> >> >> > >>>;
